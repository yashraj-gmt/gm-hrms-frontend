...
export const ROUTE_PERMISSIONS = {
  ...
  [ROUTES.EMPLOYEE_DRAFT]: [ROLES.ADMIN, ROLES.HR],
  [ROUTES.EMPLOYEE_VIEW]: [ROLES.ADMIN, ROLES.HR],
  [ROUTES.EMPLOYEE_TRAINEE_VIEW]: [ROLES.ADMIN, ROLES.HR],
  [ROUTES.EMPLOYEE_TRAINEE_EDIT]:   [ROLES.ADMIN, ROLES.HR],
[ROUTES.EMPLOYEE_TRAINEE_DRAFT]:  [ROLES.ADMIN, ROLES.HR],
